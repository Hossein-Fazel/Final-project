...
//  ======================================= virtual functions =====================================
        ...
        virtual int Validating_Username(std::string) {};                      // the validation of a user's username
        virtual std::string to_lower(std::string) {};                         // makes a string a lowercase
        virtual std::string remove_atsing(std::string) {};                    // removes @ from the first of the user name
